...
import singaporeHospital from "@/assets/singapore-hospital.jpg";
import { Header } from "@/components/site/Header";
export const Route = createFileRoute("/Countries/Singapore")({
  head: () => ({
    meta: [
      { title: "Recruitment to Singapore — Ozone Overseas" },
      {
        name: "description",
        content:
          "Placing nurses, allied health, and technical specialists from India into verified roles across Singapore — SNB and MOM compliant, since 2009.",
      },
      { property: "og:title", content: "Recruitment to Singapore — Ozone Overseas" },
      {
        property: "og:description",
        content:
          "396 professionals placed. 38 live roles today. SNB-compliant recruitment for Singapore's hospitals and precision engineering sectors.",
      },
...
const LIVE_ROLES = [
  { title: "ICU Registered Nurse", city: "Novena", salary: "SGD 3.6–4.5k" },
  { title: "Precision Engineer", city: "Jurong", salary: "SGD 2.8–3.8k" },
  { title: "Enrolled Nurse", city: "Outram", salary: "SGD 2.4–3.2k" },
];
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <p className="text-[13px] font-semibold text-[color:var(--color-brand-navy)]">
          Live Roles Today —{" "}
          <span className="text-[color:var(--color-brand-blue)]">38 Open Positions</span>
        </p>
      </div>
      ...
      <div className="relative mx-auto grid min-h-[100vh] max-w-7xl grid-cols-1 items-center gap-12 px-6 py-16 lg:grid-cols-2">
        ...
        <div className="relative z-10">
          <p className="text-xs text-black/50">
            ...
            {" / "}Countries{" / "}
            <span className="text-[color:var(--color-brand-navy)]">Singapore</span>
          </p>
          ...
          <span className="mt-5 inline-flex items-center gap-2 rounded-full border border-[color:var(--color-brand-blue)]/20 bg-[color:var(--color-brand-lightblue)] px-3.5 py-1.5 text-xs font-semibold text-[color:var(--color-brand-blue)]">
            🇸🇬 Healthcare & Precision Engineering
          </span>
          ...
          <h1 className="mt-6 font-display text-5xl font-bold leading-[1.05] tracking-tight text-[color:var(--color-brand-navy)] md:text-6xl">
            Recruitment to
            <br />
            <span className="text-[color:var(--color-brand-blue)]">Singapore.</span>
          </h1>

          <p className="mt-5 max-w-xl text-[17px] leading-relaxed text-black/60">
            Placing nurses, allied health professionals, and precision-engineering specialists from
            India into verified roles across Singapore's hospitals and industrial cluster — since
            2009.
          </p>
...
function About() {
  const glance: [string, string][] = [
    ["Capital", "Singapore"],
    ["Primary Hiring Clusters", "Novena · Outram · Jurong"],
    ["Key Licenses", "SNB · AHPC · MOM"],
    ["Avg. Process", "8–12 weeks"],
    ["Currency", "SGD"],
    ["Working Hours", "42–44 hrs/week"],
  ];
  return (
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-2">
        <div className="relative">
          <div className="overflow-hidden rounded-[24px] shadow-[0_25px_60px_-30px_rgba(11,31,58,0.4)]">
            <img
              src={singaporeHospital}
              alt="Nurse walking through modern Singapore hospital corridor"
              width={1000}
              height={1200}
              loading="lazy"
        ...
        <div>
          ...
          <h2 className="mt-3 font-display text-4xl font-bold leading-tight text-[color:var(--color-brand-navy)] md:text-[42px]">
            Recruiting Healthcare and Precision Talent for the Singapore Market.
          </h2>
          <div className="mt-6 space-y-4 text-[16px] leading-relaxed text-black/65">
            <p>
              Singapore's Healthier SG programme and world-class hospital cluster have driven steady
              demand for qualified nurses, allied health professionals, and technical specialists
              across the public and private healthcare systems.
            </p>
            <p>
              Since 2009, Ozone Overseas has partnered with Singapore employers — from restructured
              hospitals to precision engineering firms in Jurong — to place healthcare and technical
              professionals from India into verified, long-term roles.
            </p>
            <p>
              We cover ICU, ER, medical–surgical, aged care, physiotherapy, radiography, and
              precision-engineering trades — all screened to employer specification and supported
              through SNB / AHPC registration, MOM work pass, and relocation from application to
              arrival.
            </p>
            <p>
              Every healthcare placement requires SNB or AHPC registration. Our team handles the
              file, credential verification, and interview coordination alongside the work-pass
              process.
            </p>
          </div>
...
function Eligibility() {
  const cards = [
    ...
    },
    {
      num: "02",
      icon: "📜",
      title: "SNB / AHPC Registration Eligibility",
      body: "Healthcare candidates must be eligible for Singapore Nursing Board or Allied Health Professions Council registration. Ozone supports the application end-to-end.",
      variant: "lightblue",
    },
    {
      num: "03",
      ...
      body: "IELTS 7.0 (or equivalent OET) is required for most nursing roles. Technical roles need functional workplace English.",
      variant: "white",
    },
    {
      num: "04",
      ...
      body: "Minimum 2 years for RN roles. Enrolled Nurse and technical roles accept 1+ year with structured onboarding support.",
      variant: "grey",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-black/60">
            General requirements for healthcare and technical roles in Singapore. Exact criteria
  ...
  const steps = [
    {
      num: "01",
      title: "Apply",
      body: "Submit your application or browse current Singapore openings.",
      meta: "Free · No format needed",
    },
    {
      num: "02",
      title: "Credential & IELTS Screening",
      body: "Our team verifies qualifications, IELTS/OET, and SNB / AHPC eligibility.",
      meta: "1–2 wks · Pre-screened",
    },
    {
      num: "03",
      title: "Employer Interview & Registration",
      body: "Employer interviews (often virtual), SNB/AHPC file submission, and offer.",
      meta: "Weeks 3–8 · Fully coordinated",
    },
    {
      num: "04",
      title: "MOM Work Pass & Relocation",
      body: "In-Principle Approval, medicals, flights, and pre-departure orientation to your first day.",
      meta: "Weeks 9–12 · Full support",
    },
  ];
  return (
    <section className="relative overflow-hidden bg-[color:var(--color-brand-lightblue)]/40 py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-black/60">
            Most candidates complete the full process — from application to boarding — within 8 to
            12 weeks, depending on SNB / AHPC turnaround.
          </p>
        </div>
...
const JOBS: Job[] = [
  {
    ...
    employer: "Restructured Tertiary Hospital",
    tags: ["Full-time", "2+ yrs experience", "SNB registration"],
    salary: "SGD 3,600–4,500 / month",
  },
  {
    category: "Technical",
    city: "Jurong",
    title: "Precision Engineering Technician",
    employer: "Advanced Manufacturing Group",
  ...
  },
  {
    category: "Healthcare",
    city: "Outram",
    title: "Enrolled Nurse — Med Surg",
    employer: "Public Healthcare Cluster",
    tags: ["Full-time", "1+ yr experience", "SNB EN registration"],
  ...
  },
  {
    ...
    tags: ["Full-time", "2+ yrs experience", "AHPC registration"],
    salary: "SGD 3,400–4,300 / month",
  },
];
  ...
  return (
    <section id="jobs" className="relative overflow-hidden bg-white py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <h2 className="font-display text-4xl font-bold text-[color:var(--color-brand-navy)] md:text-[42px]">
            Current Openings in Singapore.
          </h2>
          <p className="mt-4 text-[16px] leading-relaxed text-black/60">
            A sample of roles currently open with our Singapore employer partners.
          </p>
        </div>
  ...
  return (
    <section className="relative overflow-hidden bg-white py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <h2 className="font-display text-4xl font-bold text-[color:var(--color-brand-navy)] md:text-[42px]">
            A Track Record Built in the Lion City.
          </h2>
          <p className="mt-4 text-[16px] leading-relaxed text-black/60">
            Since 2009, Ozone has placed 396 healthcare and technical professionals into roles
            across Singapore.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 items-stretch gap-5 md:grid-cols-4">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-[color:var(--color-brand-navy)] p-10 text-white md:col-span-2">
            ...
            <p className="relative font-display text-6xl font-bold">28+</p>
            ...
            <p className="relative mt-4 max-w-md text-sm leading-relaxed text-white/70">
              Active partnerships with public healthcare clusters, private hospitals, and precision
              manufacturing firms across Singapore.
            </p>
          </div>
...
const FAQS = [
  {
    q: "Do I need SNB registration before I apply to roles in Singapore?",
    a: "No. You can apply first — SNB registration is handled during our screening and pre-departure process. Ozone supports the application, credential verification, and any assessment or bridging requirements end-to-end.",
  },
  {
    q: "What is the typical salary range for nursing roles?",
    a: "Registered Nurse roles in Singapore typically pay between SGD 3,200 and SGD 4,500 per month depending on specialty, experience, and employer. ICU, ER, and OT roles sit at the higher end. Enrolled Nurses typically earn SGD 2,400–3,200.",
  },
  {
    q: "How long does the full process take?",
    a: "For most healthcare and technical placements, the full process from application to arrival takes 8 to 12 weeks. Timing depends primarily on SNB / AHPC registration turnaround and MOM work pass approval.",
  },
  {
    q: "Do I need IELTS to work in Singapore?",
    a: "Yes, most nursing roles require IELTS 7.0 (Academic) or an equivalent OET score. Technical roles typically require functional workplace English rather than a formal test. We advise on the exact requirement per role.",
  },
  {
    q: "Is accommodation provided for placements?",
    a: "Accommodation varies by employer. Public healthcare clusters often provide a housing allowance or subsidised nurses' quarters for the first year. Details are confirmed on the offer letter before you accept a role.",
  },
  {
  ...
  return (
    <footer className="relative bg-[color:var(--color-brand-navy)] text-white">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-16 md:grid-cols-4">
        ...
        {[
          { h: "Countries", l: ["Singapore", "Saudi Arabia", "UAE", "United Kingdom"] },
