...
export const Route = createFileRoute("/Countries/Kuwait")({
  head: () => ({
    meta: [
      { title: "Recruitment to Kuwait — MOH Kuwait Nursing Jobs | Ozone Overseas" },
      {
        name: "description",
        content:
          "MOH Kuwait-licensed recruitment. Nurses and allied health roles across Kuwait City, Salmiya and Hawalli — verified employers, 6–8 week process.",
      },
      { property: "og:title", content: "Recruitment to Kuwait | Ozone Overseas" },
      {
        property: "og:description",
        content:
          "Placing healthcare professionals from India into MOH Kuwait-verified roles since 2009.",
      },
      { property: "og:image", content: kuwaitHero },
      { name: "twitter:image", content: kuwaitHero },
    ],
  }),
...
function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--brand-light)]">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-5 py-16 lg:grid-cols-[1.35fr_1fr] lg:gap-14 lg:px-8 lg:py-20">
        {/* Left */}
        <div className="relative z-10">
          <nav className="mb-6 text-xs font-medium text-muted-foreground">
            ...
            / <span>Countries</span> / <span className="text-[var(--brand-navy)]">Kuwait</span>
          </nav>
          ...
          <h1 className="mt-6 font-display text-2xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-4xl lg:text-5xl xl:text-6xl">
            Verified Healthcare
            <br />
            <span className="text-[var(--brand)]">Talent for Kuwait.</span>
          </h1>
          <p className="mt-4 max-w-xl text-sm leading-relaxed text-foreground/70 sm:text-base">
            Placing nurses and allied health professionals from India into MOH Kuwait-verified roles
            across Kuwait City — directly with government and private hospital networks since 2009.
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a
              href="#roles"
              className="inline-flex items-center gap-2 rounded-full bg-[var(--brand-navy)] px-5 py-2.5 text-sm font-semibold text-white shadow-[var(--shadow-card)] transition hover:translate-y-[-1px] hover:bg-[var(--brand)]"
            >
              View Open Roles <ChevronDown className="h-4 w-4" />
            </a>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border-2 border-[var(--brand)] px-5 py-2.5 text-sm font-semibold text-[var(--brand)] transition hover:bg-[var(--brand)] hover:text-white"
            >
        ...
        <div className="relative">
          ...
          >
            <img
              src={kuwaitHero}
              alt="Kuwait City skyline with Al Hamra tower at golden hour"
              width={900}
              height={1200}
...
function AtAGlance() {
  const items: [string, string][] = [
    ["Capital", "Kuwait City"],
    ["License", "MOH Kuwait"],
    ["Key Cities", "Kuwait City · Salmiya · Hawalli"],
        ...
        <div className="relative grid grid-cols-1 gap-10 rounded-[28px] border border-[var(--brand)]/20 bg-white p-8 shadow-[var(--shadow-card)] sm:p-12 lg:grid-cols-[1.1fr_1fr]">
          <div>
            ...
            <div className="mt-2 font-display text-lg font-bold text-[var(--brand-navy)]">
              Professionals Placed in Kuwait Since 2009
            </div>
            <p className="mt-5 max-w-md text-sm leading-relaxed text-foreground/70">
              Kuwait's government hospital network is expanding, and MOH Kuwait applies some of the
              strictest eligibility rules in the region. Direct employer relationships — not broker
              chains — decide who moves through the process on time. That's the model we've run here
              for 15 years.
            </p>
          </div>
...
function Eligibility() {
  const rows = [
    ...
    [
      "MOH Kuwait License Eligibility",
      "Candidates must pass DataFlow verification and MOH Kuwait registration. Ozone manages the full application.",
    ],
    [
      "English Proficiency",
    ...
    [
      "Relevant Experience",
      "Minimum 2 years post-qualification experience for most MOH Kuwait roles.",
    ],
  ];
  return (
    <section className="relative overflow-hidden bg-muted/40 py-24">
      ...
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        <h2 className="max-w-3xl font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
          What It Takes to Qualify for Kuwait.
        </h2>
        <p className="mt-4 max-w-2xl text-base text-foreground/70">
          MOH Kuwait has specific eligibility requirements. Every candidate is pre-checked before
...
function Jobs() {
  const roles = [
    ["Healthcare", "Staff Nurse", "Kuwait City", "Government Hospital Network", "KWD 350–480/mo"],
    ["Healthcare", "ICU Nurse", "Salmiya", "Private Hospital Group", "KWD 400–550/mo"],
    ["Healthcare", "Pharmacy Technician", "Kuwait City", "MOH Kuwait Facility", "KWD 320–420/mo"],
    ...
    <section id="roles" className="relative overflow-hidden py-24">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <h2 className="max-w-3xl font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
              Current Openings in Kuwait.
            </h2>
            <p className="mt-4 max-w-2xl text-base text-foreground/70">
              Roles open with our Kuwait employer partners — updated weekly.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            See All Kuwait Roles <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </div>
    </section>
...
function TrackAndProcess() {
  ...
  const steps = [
    ...
    [
      ...
      "DataFlow verification and MOH Kuwait registration, managed end-to-end.",
    ],
    ["03", "Visa & Documentation", "Employer contract, visa stamping and pre-departure paperwork."],
    [
      "04",
      "Boarding & Settlement",
      "Flights, arrival support and first-week orientation in Kuwait.",
    ],
  ];
  return (
    <section className="relative overflow-hidden bg-muted/40 py-24">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 px-5 lg:grid-cols-[2fr_3fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-foreground/70">
            Fifteen years of Kuwait placements, built on strict MOH compliance and direct hospital
...
function FAQ() {
  const items = [
    {
      q: "What are MOH Kuwait's eligibility requirements?",
      a: "A government-recognized nursing or allied health qualification, DataFlow verification, MOH Kuwait registration, and typically 2+ years of relevant post-qualification experience. Ozone runs the full check before you're submitted to any employer.",
    },
    {
      q: "What is the typical salary for nurses in Kuwait?",
      a: "Staff nurse packages sit around KWD 350–480/month; ICU and specialty roles reach KWD 400–550/month. Most packages include accommodation, transport and annual leave in line with Kuwait labour norms.",
    },
    {
      q: "How long does the Kuwait visa process take?",
    ...
    {
      q: "Does Ozone charge candidates any fee for Kuwait placements?",
      a: "No. We are paid by employers. Candidates pay zero recruitment fees — this is a core compliance rule and it applies to every Kuwait placement.",
    },
  ];
  return (
    <section className="relative py-24">
      <div className="mx-auto max-w-4xl px-5 lg:px-8">
        <h2 className="font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
          Questions About Working in Kuwait.
        </h2>
        <Accordion
          type="single"
          collapsible
...
function FinalCTA() {
  const preview = [
    ["Staff Nurse", "Kuwait City", "KWD 350–480"],
  ...
  return (
    <footer className="bg-[var(--brand-navy)] text-white/85">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-10 px-5 py-16 md:grid-cols-4 lg:px-8">
        ...
        <FooterCol
          title="Countries"
          items={["Kuwait", "Qatar", "Saudi Arabia", "United Arab Emirates"]}
        />
        <FooterCol
          title="For You"
