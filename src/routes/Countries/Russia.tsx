...
export const Route = createFileRoute("/Countries/Russia")({
  head: () => ({
    meta: [
      { title: "Recruitment to Russia — Roszdravnadzor Nursing Jobs | Ozone Overseas" },
      {
        name: "description",
        content:
          "Roszdravnadzor-compliant recruitment to Russia. Medical Sister and allied health roles across Moscow, Saint Petersburg and Kazan — verified employers, 8–11 month pathway.",
      },
      { property: "og:title", content: "Recruitment to Russia | Ozone Overseas" },
      {
        property: "og:description",
        content:
          "Placing healthcare professionals from India into Roszdravnadzor-recognised roles across Russia.",
      },
      { property: "og:image", content: russiaHero },
      { name: "twitter:image", content: russiaHero },
    ],
  }),
...
function WaveBlob({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 400 400" className={className} aria-hidden xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="deb" x1="0" x2="1" y1="0" y2="1">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 py-16 lg:grid-cols-[1.35fr_1fr] lg:gap-14 lg:px-8 lg:py-20">
        <div className="relative z-10">
          <nav className="mb-6 text-xs font-medium text-muted-foreground">
            ...
            / <span>Countries</span> / <span className="text-[var(--brand-navy)]">Russia</span>
          </nav>
          ...
          <h1 className="mt-6 font-display text-5xl font-extrabold leading-[1.02] text-[var(--brand-navy)] sm:text-6xl lg:text-[5.25rem]">
            Verified Healthcare
            <br />
            <span className="text-[var(--brand)]">Talent for Russia.</span>
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-foreground/70 sm:text-lg">
            Placing nurses and allied health professionals from India into Roszdravnadzor-recognised
            Medical Sister and Feldsher roles across Moscow, Saint Petersburg and Kazan — directly
            with state clinics and private hospital groups under Ministry of Health protocols.
          </p>
        ...
        <div className="relative">
          ...
          >
            <img
              src={russiaHero}
              alt="Moscow skyline with St. Basil's Cathedral and Kremlin at golden hour"
              width={900}
              height={1200}
...
function AtAGlance() {
  const items: [string, string][] = [
    ["Capital", "Moscow"],
    ["Recognition", "Roszdravnadzor (Federal)"],
    ["Key Cities", "Moscow · St. Petersburg · Kazan"],
    ["Currency", "Russian Ruble (RUB)"],
    ["Avg. Pathway", "8–11 months"],
    ["Active Since", "2009"],
  ];
  return (
...
function WhyRussia() {
  const tiles = [
    "Roszdravnadzor Managed End-to-End",
    "16+ Hospital Partners",
    "Free Russian A2/B1 Training",
    "Work Permit & Patent Support",
  ];
  return (
        ...
        <div className="relative grid grid-cols-1 gap-10 rounded-[28px] border border-[var(--brand)]/20 bg-white p-8 shadow-[var(--shadow-card)] sm:p-12 lg:grid-cols-[1.1fr_1fr]">
          <div>
            ...
            <div className="mt-2 font-display text-lg font-bold text-[var(--brand-navy)]">
              Professionals Placed in Russia Since 2009
            </div>
            <p className="mt-5 max-w-md text-sm leading-relaxed text-foreground/70">
              Russia's healthcare system spans federal state clinics and a fast-growing private
              hospital sector, with credential recognition handled through Rosobrnadzor and
              Roszdravnadzor. Direct employer sponsorships — not broker chains — decide who clears
              recognition on time. That's the model we've run here for 15 years.
            </p>
          </div>
...
function Eligibility() {
  const rows = [
    [
      ...
      "Government-recognized BSc or GNM nursing degree from an accredited Indian institution, eligible for Rosobrnadzor equivalence review.",
    ],
    [
      "Russian Language — A2 Minimum, B1 Preferred",
      "TORFL A2 required to enter clinical practice; B1 required for direct patient-facing roles. Ozone sponsors training end-to-end.",
    ],
    [
      "Roszdravnadzor Recognition",
      "Federal-level credential recognition and specialist certification (сертификат специалиста) through the Ministry of Health. Ozone manages the full application.",
    ],
    [
      "Relevant Experience",
      "Minimum 1–2 years post-qualification clinical experience for most hospital and polyclinic roles.",
    ],
  ];
  return (
    <section className="relative overflow-hidden bg-muted/40 py-24">
      ...
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        <h2 className="max-w-3xl font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
          What It Takes to Qualify for Russia.
        </h2>
        <p className="mt-4 max-w-2xl text-base text-foreground/70">
          Russia's Roszdravnadzor pathway has strict, ministry-driven requirements. Every candidate
          is pre-checked before being submitted to an employer.
        </p>
...
function Jobs() {
  const roles = [
    [
      "Healthcare",
      "Medical Sister (Staff Nurse)",
      "Moscow",
      "Federal Clinical Hospital",
      "RUB 95,000–120,000/mo",
    ],
    [
      "Healthcare",
      "ICU / Reanimatsiya Nurse",
      "St. Petersburg",
      "Private Hospital Group",
      "RUB 130,000–165,000/mo",
    ],
    [
      "Healthcare",
    ...
    <section id="roles" className="relative overflow-hidden py-24">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <h2 className="max-w-3xl font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
              Current Openings in Russia.
            </h2>
            <p className="mt-4 max-w-2xl text-base text-foreground/70">
              Roles open with our Russian hospital and polyclinic partners — updated weekly.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          >
            See All Russia Roles <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </div>
    </section>
...
function TrackAndProcess() {
  const pills = ["94 Placed Since 2009", "16+ Hospital Partners", "100% Roszdravnadzor Compliant"];
  const steps = [
    [
      "01",
      "Apply & Screen",
      "Send your CV — we screen credentials and language readiness within 48 hours.",
    ],
    [
      "02",
      "Russian Training & Recognition",
      "Sponsored A2/B1 TORFL training and full Rosobrnadzor dossier with the Ministry of Health.",
    ],
    [
      "03",
      "Visa & Work Permit",
      "Employer contract, HQS work permit and pre-departure paperwork through the Russian consulate.",
    ],
    [
      "04",
      "Arrival & Specialist Certification",
      "Flights, accommodation support and preparation for the сертификат специалиста examination in Russia.",
    ],
  ];
  return (
    <section className="relative overflow-hidden bg-muted/40 py-24">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 px-5 lg:grid-cols-[2fr_3fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-foreground/70">
            Fifteen years of Russian placements, built on strict Roszdravnadzor compliance and
            direct hospital relationships. No sub-agents, no shortcuts.
          </p>
...
function FAQ() {
  const items = [
    {
      q: "What is Roszdravnadzor and why does it matter?",
      a: "Roszdravnadzor is Russia's Federal Service for Surveillance in Healthcare — it oversees the recognition of foreign medical qualifications and the issuance of the сертификат специалиста (specialist certificate). Without it you cannot work in a licensed clinical role. Ozone manages the full dossier, including document apostille, Rosobrnadzor equivalence and the final specialist exam.",
    },
    {
      q: "What is the typical salary for nurses in Russia?",
      a: "Medical Sister packages sit around RUB 95,000–120,000/month gross in Moscow; ICU and specialty roles reach RUB 130,000–165,000/month. All roles include statutory OMS health insurance, 28 days paid leave and northern-region allowances where applicable.",
    },
    {
      q: "Do I need to speak Russian before I apply?",
      a: "TORFL A2 is the minimum entry level for clinical work; B1 is required for direct patient-facing roles. Ozone sponsors accredited Russian language training from A1 through B1 for shortlisted candidates.",
    },
    {
      q: "Does Ozone charge candidates any fee for Russia placements?",
      a: "No. We are paid by employers under Ministry of Labour-compliant terms. Candidates pay zero recruitment fees — this is a core compliance rule and it applies to every Russia placement.",
    },
  ];
  return (
    <section className="relative py-24">
      <div className="mx-auto max-w-4xl px-5 lg:px-8">
        <h2 className="font-display text-4xl font-extrabold leading-[1.1] text-[var(--brand-navy)] sm:text-5xl">
          Questions About Working in Russia.
        </h2>
        <Accordion
          type="single"
          collapsible
...
function FinalCTA() {
  const preview = [
    ["Medical Sister", "Moscow", "RUB 95,000–120,000"],
    ["ICU Nurse", "St. Petersburg", "RUB 130,000–165,000"],
  ];
  return (
      ...
      <div className="bg-[var(--brand-light)]">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-5 py-16 lg:grid-cols-2 lg:px-8">
          ...
          <div className="justify-self-center w-full max-w-md rounded-2xl bg-white p-5 shadow-[var(--shadow-soft)] ring-1 ring-black/5">
            ...
            >
              View all 28 roles <ArrowRight className="h-3 w-3" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-10 px-5 py-16 md:grid-cols-4 lg:px-8">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="mt-4 text-sm text-white/60">
            Global healthcare recruitment, since 2009. Roszdravnadzor · Anerkennung · NNAS · QCHP ·
            SCFHS licensed.
          </p>
        </div>
        <FooterCol title="Countries" items={["Russia", "Germany", "Canada", "Qatar"]} />
        <FooterCol
          title="For You"
